                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="news-body">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <tr>
                                            <td>Capital gain arising out of</td>
                                            <td>Transfer of stocks and shares
                                                of any company registered <br>
                                                under CA-1994. (SRO No. -
                                                220-Act/Income tax/2004)</td>
                                                <td>10%</td>
                                            </tr>

                                            <tr>
                                                <td>Capital gain</td>
                                                <td>Transfer of Capital assets</td>
                                                <td>15%</td>
                                            </tr>

                                            <tr>
                                                <td>Bank, Insurance, Financial
                                                    Institutions</td>
                                                    <td>On trading Income</td>
                                                    <td>42.5%</td>
                                                </tr>

                                                <tr>
                                                    <td>Mobile Phone Operator</td>
                                                    <td>If converted into Public
                                                    ...
                                                    <tr>
                                                        <td>On Dividend Income</td>
                                                        <td>For all company</td>
                                                        <td>20%</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table class="table table-bordered">
                                                                <tr><td>If Dividend declared less than
                                                                10% or no dividend within the
                                                                SEC stipulated time
                                                                </td></tr>
                                                                <tr><td>Other Situation
                                                                </td></tr>
                                                                <tr><td>If declared Dividend is more than 20%
                                                                </td></tr>
                                                            </table>
                                                        </td>
                                                        <td>
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tr><td>It will enjoy 10% of tax rebate on applicable Tax
                                                                </td></tr>
                                                            </table>
                                                        </td>                                                                                                                         
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            <td>Public Utility Service
                                                                Providers</td>
                                                                <td></td>
                                                                <td>25%</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Jute, Textile & Yarn
                                                                    Manufacturing</td>
                                                                    <td></td>
                                                                    <td>15%</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Export Oriented Garments
                                                                        Industries</td>
                                                                        <td></td>
                                                                        <td>.50%</td>
                                                                    </tr>
