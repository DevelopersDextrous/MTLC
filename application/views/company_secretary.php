                    ...
                    <div class="col-padded"><!-- inner custom column -->
                        ...
                        <div class="row gutter"><!-- row -->
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <h1 class="page-title">Company Secretary</h1>
                                
                                <div class="news-body">
                                
                                    <p class="call-out">
                                    Company legislation requires businesses to perform many administration tasks that take up a lot of valuable company time. The last thing you need as a business owner is to be stressed out trying to ensure you are complying with the Companies Act 1994.
                                    </p>
                                    ...
                                    <p>
                                        At <b>MTLC (MILLENIUM TAX &amp; LAW CHAMBER)</b> we are able to relieve this burden for you. Our services include:

                                        <ul class="l1">
                                            <li>Company formations</li>
                                            <li>Filing of annual returns on your behalf</li>
                                            <li>Preparation of all documentation related to minutes and resolutions</li>
                                            <li>Maintenance of statutory books</li>
                                            <li>Assistance in changes of directors, shareholders, addresses and office details</li>
                                            <li>Advice on financing</li>
                                            <li>Bonus Issues</li>
                                            <li>Share transfers</li>
                                            <li>Registered Office Facility</li>
                                        </ul>
                                    </p>

                                    <p>
                                        Calling on the skills of professionals' means you will be far less likely to purchase an unsuitable business. Let MTLC show you how their experience can save you from stress, and provide you with the great opportunity a business acquisition or merger can be.
                                    </p>
