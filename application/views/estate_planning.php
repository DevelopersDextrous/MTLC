                        ...
                        <div class="row gutter"><!-- row -->
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="news-body">
                                    ...
                                    <p class="call-out">
                                        As unpleasant as the task is, estate planning is one of the necessities in life.
It allows peace of mind knowing your hard earned assets will be dealt with in the manner
you choose.
</p>
                                    
                                    <p>
                                        For business owners, a plan for succession of ownership is essential. We can guide you
through the process of providing for business continuity.
                                    ...
                                    <p>
                                        The areas involved in estate administration we are able to assist with include:
                                        <li>Meeting to discuss objectives for your estate</li>
                                        <li>Confirming assets - valuations, inventories, appraisals</li>
                                        <li>Court approval for a grant of administration</li>
                                        <li>Documentation involved in estate planning</li>
                                        <li>Protecting the assets</li>
                                        <li>Paying taxes and debts</li>
                                        <li>Estate distribution</li>
                                        <li>Administration Act</li>
                                    </p>
