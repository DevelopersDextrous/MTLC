                    ...
                    <div class="col-padded"><!-- inner custom column -->
                        ...
                        <div class="row gutter"><!-- row -->
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <h1 class="page-title">Selling a Business</h1>
                                
                                <div class="news-body">
                                
                                    <p class="call-out">
                                    Selling a business can be a difficult, often disheartening time. In this state the tasks involved in selling a business can seem particularly arduous. Here at <b>MTLC</b> we are able to relieve that stress for you.
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        <ul class="l1">
                                            <li>Preparation of a sales memorandum</li>
                                            <li>Obtaining comparative results</li>
                                            <li>Establishing a realistic sales price</li>
                                            <li>Taking the business to the market</li>
                                            <li>Negotiating with potential purchasers</li>
                                        </ul>
                                    </p>
