                        ...
                        <div class="row gutter"><!-- row -->
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="news-body">
                                    ...
                                    <p class="call-out">
                                        At <b>MTLC</b> we offer a full range of taxation services.
                                    </p>

                                    <p>
                                     Taxation can be a major cost to your business. We will work in partnership with you to
                                     minimise your tax and help you achieve your key objectives.
                                 </p>
                                 <p>
                                    We provide a complete service of assistance and advice in all of the following areas:
                                    <div style="margin-left:5%">
                                        <li>Preparation of personal;</li>
                                        <li>Company and trust tax returns and advice on payment of tax;</li>
                                        <li>VAT obligations</li>
                                        <li>Advice on and implementation of tax effective structures for asset protection and tax
                                            minimization;</li>
                                        <li>Management of any disputes;</li>
                                        <li>Keeping company aside any non compliances.</li>
                                        </div>
                                    </p>
                                </div>
