                        ...
                        <div class="row gutter"><!-- row -->
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="news-body">
                                    ...
                                    <p class="call-out">
                                        VAT legislation is an area we know like the back of our hand. We are able to offer accurate, timely assistance in a number of areas. These include:

                                        <ul class="l1">
                                            <li>Registration queries</li>
                                            <li>Preparation of VAT retrurns</li>
                                            <li>Filing and adjusting VAT returns</li>
                                            <li>IRD audit assitance</li>
                                            <li>Specialist events involving VAT</li>
                                            <li>Claimiming Rebate</li>
                                            
                                        </ul>
                                    </p>

                                    <h4 style="margin-top:15px; margin-bottom:15px;">Registration:</h4>
                                    <p class="call-out">
                                        Every producer of taxable goods and services are required to registered under the VAT Act-1991 if his annul turnover exceed Tk 40 Lac. Separate registration for every production center shall be required. But in case of sales outlet Central Registration may be applied for but warehouse should have to be maintained centrally.
                                    </p>

                                    <h4 style="margin-top:15px; margin-bottom:15px;">Vat Rate:</h4>
                                    <p class="call-out">
                                        Generally 15% is chargeable on value addition but incase of services there may some deemed value addition.
                                    </p>

                                    <h5 style="margin-top:15px; margin-bottom:15px;">Submission on Vat Return:</h5>
                                    <p class="call-out">
                                        Two copies of return (Mushak-19) shall be submitted within 10 days from the tax period to the proper officer( 20th day for insurance company) by attaching the following documents:
                                    </p>

                                    <ol>
                                        <li>Copies of Current Account</li>
                                        <li>The bill of entry or Mushak-11 relating to purchase</li>
                                        <li>Original &amp; Second copy of treasury challan in case of service</li>
                                        <li>Any other documents required by Commissioner</li>
                                    </ol>
